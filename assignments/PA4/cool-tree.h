...
public:
    ...
    virtual void addTo(defClass& c) = 0;
    virtual void semant(const defClass& c) = 0;
...
public:
    ...
    virtual Symbol semant(const defClass& c) = 0;
...
public:
    ...
    void addTo(defClass &c) override;
    void semant(const defClass& c) override;
    void dump(ostream &stream, int n);
...
public:
    ...
    Case copy_Case();
    Symbol semant(const defClass& c) override;
    void dump(ostream &stream, int n);
